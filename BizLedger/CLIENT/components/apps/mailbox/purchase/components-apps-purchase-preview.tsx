...
const ComponentsAppsPurchasePreview = () => {
    ...
    return (
        <div>
            <div className="mb-6 flex flex-wrap items-center justify-center gap-4 lg:justify-end">
                ...
                {canCreatePurchase && (
                    <Link href="/apps/purchase/add" className="btn btn-secondary gap-2">
                        <IconPlus />
                        Create
                    </Link>
                )}
                ...
                {canUpdatePurchase && (
                    <Link href="/apps/purchase/edit" className="btn btn-warning gap-2">
                        <IconEdit />
                        Edit
                    </Link>
                )}
            ...
            <div className="panel">
                <div className="flex flex-wrap justify-between gap-4 px-4">
                    <div className="text-2xl font-semibold uppercase">Purchase Voucher</div>
                    ...
                    <div className="flex flex-col justify-between gap-6 sm:flex-row lg:w-2/3">
                        <div className="xl:1/3 sm:w-1/2 lg:w-2/5">
                            <div className="mb-2 flex w-full items-center justify-between">
                                <div className="text-white-dark">Purchase Voucher :</div>
                                <div>#8701</div>
                            </div>
                            <div className="mb-2 flex w-full items-center justify-between">
                ...
                <div className="mt-6 overflow-x-visible">
...
export default ComponentsAppsPurchasePreview;
